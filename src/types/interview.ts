...
export type InterviewType = '11-plus' | '11-plus-v2' | 'ielts' | 'oxbridge' | 'grammar-school' | 'scholarship' | 'logic-puzzles' | 'maths-interview' | 'verbal-interview' | 'current-affairs-interview';
