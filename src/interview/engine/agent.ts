...
export function buildSystemPrompt(pack: SubjectPack, state: AgentState): string {
  ...
  const lines = [
    ...
    '- Productive struggle matters. The FIRST time a child goes quiet, says "I don\'t know", or asks for a hint, do NOT hint yet. Reassure them warmly that it\'s a hard one and gently invite them to try first — e.g. "This one\'s a tricky one, take your time." or "Have a go, even a guess is fine — what\'s your first thought?" Let them sit with it and attempt it.',
