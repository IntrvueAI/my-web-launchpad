...
const ENGINE_SCORED = new Set(['logic-puzzles', 'maths-interview', 'verbal-interview', 'current-affairs-interview', '11-plus', 'medicine-mmi', 'medicine-mmi-manchester', 'medicine-oxford-pilot', 'medicine-cambridge-pilot', 'medicine-imperial-pilot', 'chat-with-clara']);
