...
export default function ExpansionLab({ standalone = false }: { standalone?: boolean }) {
  ...
  return (
    <MedicineTheme><div className={`med-lab ${standalone ? 'med-lab-standalone' : ''}`}>
      ...
      <nav className="lab-jump-nav" aria-label="Research desk sections"><a href="#build-updates">Latest updates</a><a href="#circuit-builder">Circuit builder</a><a href="#rehearsal">Draft review</a><a href="#content-coverage">Coverage & exports</a><a href="#school-evidence">School evidence</a>{isDev&&<a href="/__dev/medicine-design">Dashboard preview ↗</a>}</nav>
